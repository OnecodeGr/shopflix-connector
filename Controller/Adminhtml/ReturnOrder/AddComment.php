...
use Onecode\ShopFlixConnector\Controller\Adminhtml\ReturnOrder as OrderAction;
...
class AddComment extends OrderAction implements HttpPostActionInterface
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Onecode_ShopFlixConnector::return_order_comment';
    ...
    public function __construct(
        ...
        ReturnOrderStatusHistoryRepositoryInterface $orderStatusHistoryRepository,
