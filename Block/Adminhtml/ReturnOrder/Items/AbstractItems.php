...
namespace Onecode\ShopFlixConnector\Block\Adminhtml\ReturnOrder\Items;
...
class AbstractItems extends Template
{
     ...
     * @return string
     */
    public function getItemExtraInfoHtml(DataObject $item): string
    {
     ...
     * @param string|null $field the custom item field
     * @return string
     */
    public function getColumnHtml(DataObject $item, string $column, string $field = null): string
    {
        $block = $item->getOrderItem() ? $this->getColumnRenderer($column, $item->getOrderItem()->getProductType()) : $this->getColumnRenderer($column, $item->getProductType());
     ...
     * @throws LocalizedException
     */
    public function displayPrices(float $price, bool $strong = false, string $separator = '<br />'): ?string
    {
     ...
     * @throws LocalizedException
     */
    public function displayRoundedPrices(float $price, int $precision = 2, bool $strong = false, string $separator = '<br />'): string
    {
     ...
     *
     * @return ReturnOrderInterface | ReturnOrderItemInterface
     * @throws LocalizedException
     */
