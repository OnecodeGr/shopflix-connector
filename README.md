# Connect Magento with SHOPFLIX [![GitHub version](https://badge.fury.io/gh/OnecodeGr%2Fshopflix-connector.svg)](https://badge.fury.io/gh/OnecodeGr%2Fshopflix-connector) [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](./LICENSE.md) [![PHP Version Require](http://poser.pugx.org/onecode/shopflix-connector/require/php)](https://packagist.org/packages/onecode/shopflix-connector)
